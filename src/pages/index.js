  ...
  <Layout>
    ...
    <div className='row pitch-container'>
      <div className='col s12 m6 l5 offset-m3'>
       <Image className='headshotImage' alt='headshot-image' />
      </div>
      <section className='col s12 m12 l7 pitch'>
        <h4>My Elevator pitch:</h4>
        <p className='pitch-desc'>I am current looking for a new position as a software engineer. My previous role was a full stack engineer at InfoImage grew my strengths and enjoyment in full stack development. The use of new and modern technologies excite me, such as <strong>React</strong> and <strong>NodeJS</strong>. One of the side projects which helped grow my modern skillset was my <Link to="/projects/internalTools">Internal Tools.</Link> I also have a solid amount of experience in other places such as <strong>Java, Oracle SQL, and MongoDB</strong>. Outside of development, I enjoy learning about music theory. I am currently open to new opportunities so feel free to <a href="mailto:bryant.t.tran1@gmail.com">email</a> or connect with me on <a href="https://www.linkedin.com/in/bryanttran1/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.</p>
      </section>
    </div>
...
export const Image = () => {
  const query = useStaticQuery(graphql`
    query {
      placeholderImage: file(relativePath: { eq: "BryantTran.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1200 ) {
